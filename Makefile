...
SRC := main.cpp thread.cpp thread_pool.cpp random_num_gen.cpp image_processor.cpp lz77.cpp scanline.cpp greyscale.cpp
OBJ := $(SRC:.cpp=.o)
TARGET := main
...
%.o: %.cpp thread.hpp thread_pool.hpp image_processor.hpp lz77.hpp greyscale.hpp scanline.hpp
	$(CXX) $(CXXFLAGS) -c $< -o $@
...
test_scanline.o: test_scanline.cpp scanline.hpp image_processor.hpp greyscale.hpp
	$(CXX) $(CXXFLAGS) -c $< -o $@

test-scanline: test_scanline.o scanline.o image_processor.o greyscale.o
	$(CXX) $(CXXFLAGS) -o $@ $^
